...
class ElsxWebsiteAiDraft(models.Model):
    ...
    asset_strategy = fields.Selection([
        ('odoo_first', 'Use Platform Media First'),
    ...
    def _build_prompt_text(self):
        ...
        return _(
            ...
            "Available platform asset candidates: %(asset_candidates)s\n"
            ...
            "HTML must be clean Bootstrap website section markup only. Prefer core snippet structures and classes such as "
            ...
            "Use <a class='btn'> for CTAs, not <button>. Use Bootstrap-friendly section classes, containers, rows, columns, cards, badges, and responsive utilities.\n"
            ...
            "Keep it production-ready, easy to edit in Website, visually premium, mobile-safe, and free of generic filler.\n"
            ...
            for term in terms[:6]:
                ...
                for attachment in attachments:
                    add_candidate(
                        ...
                        _('Matched platform media for "%s"') % term,
                    )
                    if len(candidates) >= limit:
                        return candidates
        ...
        if not candidates and self._registry_has_model('product.template') and self.asset_strategy != 'no_images':
            for product in self.env['product.template'].sudo().search([('image_1920', '!=', False)], limit=3):
                add_candidate(
                    ...
                    product.display_name,
                    '/web/image/product.template/%s/image_1024' % product.id,
                    _('Recent product image available in the platform'),
                )
    ...
    def _asset_showcase_html(self, candidates=False):
        if self.asset_strategy == 'no_images':
            return (
                ...
                '<p>Add final imagery from the Website editor when ready.</p>'
                '</div>'
            )
        ...
        return (
            ...
            escape(_('No matching platform media was found. Add a product, catalogue, factory, team, or proof image from the Website editor.')),
        )
    ...
    def _inject_asset_showcase(self, html, candidates=False):
        ...
        section = (
            ...
            visual,
            escape(_('Use real platform media, not random placeholders')),
            escape(_('This draft reserves image space and links it to media already available in the platform so the final page remains editable and production-safe.')),
        )
    ...
    def _quality_report(self, html, css, seo_title=False, seo_description=False):
        ...
        add('Responsive grid classes', 'container' in html and 'row' in html and 'col-' in html, 11)
    ...
    def _build_local_payload(self, reason=False):
        ...
        proof_items = [
            ...
            ('Editor-ready', 'Use Website sections, rows, cards, and CTA links that can be edited manually.'),
        ...
        faq_items = [
            ...
            ('Can the design be changed later?', 'Yes. The output uses editable Website sections instead of locked custom scripts.'),
        ]
        faq_html = ''.join(
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 pb24">
        ...
        <p class="lead h5-fs">Editable website sections with clear hierarchy, proof, and conversion actions.</p>
...
"""
    ...
    def _build_local_payload(self, reason=False):
        ...
        behavior use this stronger editor-friendly page architecture.
        """
        self.ensure_one()
        title = self._infer_page_title()
        headline = self._headline_from_instruction()
        ...
        proof_html = ''.join(
            ...
            for label, body in [
                ...
                (_('Editor-ready'), _('website sections, rows, images, cards, and CTA links.')),
        ...
        faq_html = ''.join(
            ...
            for question, answer in [
                ...
                (_('Can the design be changed later?'), _('Yes. The output stays editable in the standard Website editor.')),
            ]
        )
...
"""
    ...
    def _website_page_model_for_create(self, website):
        ...
        only supported view modes. Keeping the page-create context clean prevents
    ...
    def _repair_ai_payload(self, original_output, quality_checklist, asset_candidates=False):
        ...
        repair_instruction = _(
            ...
            "- Build 6-9 Website editable sections for full-page work.\n"
...
class ElsxCeAiCommand(models.Model):
    ...
    def _command_guides(self):
        return {
            ...
            'module_spec': 'Create a technical ERP module spec with models, views, security, deployment, tests, and rollback notes.',
    ...
    def _build_command_prompt(self):
        ...
        return _(
            "You are ELSxGlobal's Community Edition AI Command Center.\n"
            "Goal: unlock advanced AI workflows in Community Edition using safe custom modules, not Enterprise license bypasses.\n"
    ...
    def _fallback_payload(self, reason=False):
        ...
        artifact = _(
            ...
            "## Architecture\n- Use existing Community Edition models and custom addon inheritance.\n"
