...
MODULES="${MODULES:-elsx_client_restrictions,elsx_rebrand,elsx_whatsapp_marketing,elsx_attendance_tracking,elsx_tally_integration}"
INSTALL_MODULES="${INSTALL_MODULES:-elsx_client_restrictions,elsx_rebrand,elsx_whatsapp_marketing,elsx_attendance_tracking,elsx_tally_integration}"
